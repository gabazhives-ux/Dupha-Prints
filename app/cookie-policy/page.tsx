...
export const metadata: Metadata = {
  title: "Cookie Policy",
  description: "Dupha Prints cookie policy.",
    ...
    <>
      <section className="bg-ink-950 pb-20 pt-40 sm:pt-48">
        <div className="mx-auto max-w-4xl px-6">
          <SectionHeading eyebrow="Legal" title="Cookie Policy" light />
        ...
        <div className="mx-auto max-w-3xl px-6 text-center">
          <div className="rounded-2xl border-2 border-dashed border-ink-950/20 bg-white p-12 shadow-sm">
            ...
            <h2 className="font-display text-2xl font-bold text-ink-950">
              Our Cookie Policy is available as a PDF document.
            </h2>

            <p className="mt-4 text-base font-semibold text-ink-950/70">
              📄{" "}
              <strong>
                Click the button below to open and read our full Cookie Policy.
              </strong>
            </p>

            <p className="mt-2 text-sm text-ink-950/50">
              The document contains all information regarding how Dupha Prints
              uses cookies on our website, the types of cookies we use, and how
