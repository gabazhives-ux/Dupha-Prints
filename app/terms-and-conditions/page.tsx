...
export const metadata: Metadata = {
  ...
  description: "Dupha Prints terms and conditions.",
        ...
        <div className="mx-auto max-w-3xl px-6 text-center">
          <div className="rounded-2xl border-2 border-dashed border-ink-950/20 bg-white p-12 shadow-sm">
            ...
            <h2 className="font-display text-2xl font-bold text-ink-950">
              Our Terms & Conditions are available as a PDF document.
            </h2>

            <p className="mt-4 text-base font-semibold text-ink-950/70">
              📄{" "}
              <strong>
                Click the button below to open and read our full Terms &amp; Conditions.
              </strong>
            </p>

            <p className="mt-2 text-sm text-ink-950/50">
              The document covers acceptance of terms, orders & payment,
              production timelines, cancellations & refunds, intellectual
              property, and our governing law.
            </p>
            ...
            >
              ...
              Open / Download Terms &amp; Conditions PDF
            </a>
